<!--
  Senanur-ylmz/Senanur-ylmz — GitHub profile README

  Editing notes:
   · assets/banner.svg and assets/divider.svg are hand-written animated SVGs.
     They live in this repo on purpose: README images are proxied through camo,
     so nothing can be fetched at runtime, and hosted card services keep going
     down (github-readme-stats has been answering 503 for a long stretch).
   · assets/stats-*.svg are regenerated daily by .github/workflows/stats.yml.
     Do not edit them by hand; edit tools/stats_svg.py instead.
   · The stat cards use <picture> so they follow the reader's light/dark theme.
     If you change one URL's colours, change the sibling too.
   · Search for TODO for the optional links left commented out.
-->

<div align="center">

<img src="https://raw.githubusercontent.com/Senanur-ylmz/Senanur-ylmz/main/assets/banner.svg" alt="Senanur Yılmaz — Software Engineer, Architecht, İstanbul" width="900">
...
- 🧠 &nbsp;Happiest somewhere between backend logic and a tidy database schema
- 🐍 &nbsp;Most of my public code is Python and JavaScript
- ☕ &nbsp;Runs on tea, clean commits and slightly too many browser tabs
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/Senanur-ylmz/Senanur-ylmz/main/assets/stats-dark.svg">
  <img src="https://raw.githubusercontent.com/Senanur-ylmz/Senanur-ylmz/main/assets/stats-light.svg" alt="Repositories, stars, followers and language breakdown" width="860">
</picture>
